...
The manufactured periodic scalar (q=\sin(z/R_0)) in H¹(2) converges from 479 to
3832 tetrahedra at L² rate 3.275 (third-order gate 2.8); its platform-pinned table is
