...
- [x] **3.1** Direct-u weak form, frozen (B, p) — `DESIGN.md` §9.1, §9.4 · note: (M3), §5.5
  ...
  and checkpoint metadata. A solver-free divergence identity pins the M3 drive's
  `2/B_safe³` coefficient to 3.6e-16. B-floor activity is 1.70e-16 with sampled min |B| = 2.236;
  ...
  rejects `2→3` and `B_safe³→B_safe²` drive mutations by 8.32e-2 and 2.81e-1.
