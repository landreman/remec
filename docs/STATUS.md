...
- [x] **2.2** Profiles + transplant — `DESIGN.md` §12.5 · note: §6
  ...
  <br>Measured: macOS / CPython 3.12.2 / NGSolve 6.2.2606 — the strict analytic
  profile realizes seven enclosed-volume targets to 2.0e-3 absolute error; two
  smooth layer-cake moment residuals are 2.364e-5 and 1.190e-5 (required below
  3.0e-3). The NGSolve mapped-quadrature pass integrates the unit square to 1.0
